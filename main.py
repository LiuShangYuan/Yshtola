...
flags.DEFINE_string('sample_save_path', 'sample', "directory for saving the sampled texts")
FLAGS = flags.FLAGS

def main(_):

    model = DTN(mode=FLAGS.mode, learning_rate=0.003)
    solver = Solver(model, batch_size=200, pretrain_iter=20000, train_iter=20000,
